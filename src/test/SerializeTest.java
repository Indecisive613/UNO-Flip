...
public class SerializeTest {
    ...
    public void importGame(){
        ...
        assertEquals(game.getPlayers().get(1), importedGame.getPlayers().get(1));
        assertEquals(game.getPlayers().get(2), importedGame.getPlayers().get(2));
        assertEquals(game.getPlayers().get(3), importedGame.getPlayers().get(3));
